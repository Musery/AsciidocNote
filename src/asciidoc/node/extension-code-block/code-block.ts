...
// TODO 增加asciidoc的其他CodeBlock语法以及UI呈现方式 https://docs.asciidoctor.org/asciidoc/latest/verbatim/source-blocks/
...
export const symbolInputRegex = /^----[\s\n]$/
export const tildeInputRegex = /^\[source, ([a-z]+)?\][\s\n]$/
